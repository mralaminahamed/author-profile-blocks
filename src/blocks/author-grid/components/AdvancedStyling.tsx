...
/**
 * Advanced styling controls component for the Author Grid block
 *
	...
	return (
		...
		>
			...
			<ToggleControl
				...
				help={ __(
					'Apply a gradient background to grid items',
			...
			<div style={ { marginTop: '24px', paddingTop: '16px', borderTop: '1px solid #ddd' } }>
				...
				<RangeControl
					...
					max={ 2 }
					step={ 0.1 }
					help={ __( 'Scale grid items (1 = normal size)', 'author-profile-blocks' ) }
				/>
				...
				<RangeControl
					...
					max={ 180 }
					step={ 5 }
					help={ __( 'Rotate grid items in degrees', 'author-profile-blocks' ) }
				/>
			</div>
