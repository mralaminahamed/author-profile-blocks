		...
		<PanelBody title={__("Layout", "author-profile-blocks")}>
			...
			<SelectControl
				...
				options={[
					...
					{
						label: __("Modern Cards", "author-profile-blocks"),
						value: "modern-cards",
					},
					{
						label: __("Classic Carousel", "author-profile-blocks"),
						value: "classic-carousel",
					},
					{
						label: __("Minimal Slides", "author-profile-blocks"),
						value: "minimal-slides",
					},
					{
						label: __("Elegant Profile", "author-profile-blocks"),
						value: "elegant-profile",
					},
					{
						label: __("Creative Layout", "author-profile-blocks"),
