...
/**
 * Advanced styling controls component for the Author List block
 *
	...
	return (
		...
		>
			...
			<ToggleControl
				...
				help={ __(
					'Apply a gradient background to list items',
			...
			<div style={ { marginTop: '24px', paddingTop: '16px', borderTop: '1px solid #ddd' } }>
				...
				<RangeControl
					...
					max={ 2 }
					step={ 0.1 }
					help={ __( 'Scale list items (1 = normal size)', 'author-profile-blocks' ) }
				/>
				...
				<RangeControl
					...
					max={ 180 }
					step={ 5 }
					help={ __( 'Rotate list items in degrees', 'author-profile-blocks' ) }
				/>
			</div>
