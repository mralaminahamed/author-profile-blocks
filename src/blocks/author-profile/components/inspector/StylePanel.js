...
const StylePanel = ({ attributes, setAttributes }) => {
    ...
    return (
        <>
            ...
            {showImage && (
                <PanelBody title={__('Avatar', 'author-profile-blocks')} initialOpen={false}>
                    <RangeControl
                    ...
                    <SelectControl
                        ...
                        options={[
                            { label: __('Circle', 'author-profile-blocks'), value: 'circle' },
                            { label: __('Square', 'author-profile-blocks'), value: 'square' },
                            { label: __('Rounded', 'author-profile-blocks'), value: 'rounded' },
                            { label: __('Custom', 'author-profile-blocks'), value: 'custom' },
                        ]}
                    ...
                    <SelectControl
                        ...
                        onChange={(value) => setAttributes({ avatarAlignment: value })}
                    />
                    
                    <RangeControl
                        label={__('Margin', 'author-profile-blocks')}
                        value={avatarMargin}
                        onChange={(value) => setAttributes({ avatarMargin: value })}
                        min={0}
                        max={50}
                    />
                </PanelBody>
            ...
            <PanelBody title={__('Author Name', 'author-profile-blocks')} initialOpen={false}>
                ...
                <SelectControl
                    ...
                    options={[
                        { label: __('Normal', 'author-profile-blocks'), value: 'normal' },
                        { label: __('Bold', 'author-profile-blocks'), value: 'bold' },
                        { label: __('Light', 'author-profile-blocks'), value: '300' },
                        { label: __('Semi-Bold', 'author-profile-blocks'), value: '600' },
                        { label: __('Extra Bold', 'author-profile-blocks'), value: '800' },
                    ]}
                ...
                <SelectControl
                    ...
                    options={[
                        ...
                        { label: __('Uppercase', 'author-profile-blocks'), value: 'uppercase' },
                        { label: __('Lowercase', 'author-profile-blocks'), value: 'lowercase' },
                        { label: __('Capitalize', 'author-profile-blocks'), value: 'capitalize' },
                    ]}
                    onChange={(value) => setAttributes({ nameTransform: value })}
                />
                ...
                <SelectControl
                    ...
                    onChange={(value) => setAttributes({ nameAlignment: value })}
                />
            ...
            {showDescription && (
                <PanelBody title={__('Description', 'author-profile-blocks')} initialOpen={false}>
                    <BaseControl label={__('Text Color', 'author-profile-blocks')}>
                        <ColorPalette
                    ...
                    <SelectControl
                        ...
                        options={[
                            { label: __('Normal', 'author-profile-blocks'), value: 'normal' },
                            { label: __('Italic', 'author-profile-blocks'), value: 'italic' },
                        ]}
                        onChange={(value) => setAttributes({ descriptionStyle: value })}
                    />
                    ...
                    <SelectControl
                        ...
                        options={[
                            ...
                            { label: __('Center', 'author-profile-blocks'), value: 'center' },
                            { label: __('Right', 'author-profile-blocks'), value: 'right' },
                            { label: __('Justify', 'author-profile-blocks'), value: 'justify' },
                        ]}
                        onChange={(value) => setAttributes({ descriptionAlignment: value })}
                    />
            ...
            {(showEmail || showRegisteredDate) && (
                <PanelBody title={__('Meta Information', 'author-profile-blocks')} initialOpen={false}>
                    <BaseControl label={__('Text Color', 'author-profile-blocks')}>
                        <ColorPalette
                            value={metaColor}
                    ...
                    {showEmail && (
                        <>
                            <CardDivider />
                            <BaseControl label={__('Email Link Color', 'author-profile-blocks')}>
                                <ColorPalette
                                    value={emailLinkColor}
                                    onChange={(value) => setAttributes({ emailLinkColor: value })}
                                />
                            </BaseControl>
                            
                            <BaseControl label={__('Email Link Hover Color', 'author-profile-blocks')}>
                                <ColorPalette
                                    value={emailHoverColor}
                                    onChange={(value) => setAttributes({ emailHoverColor: value })}
                                />
                            </BaseControl>
                        </>
                    )}
            ...
            {showSocialLinks && (
                <PanelBody title={__('Social Icons', 'author-profile-blocks')} initialOpen={false}>
                    <BaseControl label={__('Icon Color', 'author-profile-blocks')}>
                        <ColorPalette
                    ...
                    <BaseControl label={__('Icon Hover Color', 'author-profile-blocks')}>
                        <ColorPalette
                    ...
                    <BaseControl label={__('Background Color', 'author-profile-blocks')}>
                        <ColorPalette
                            ...
                            onChange={(value) => setAttributes({ socialIconBackground: value })}
                        />
                    </BaseControl>
                    
                    <BaseControl label={__('Background Hover Color', 'author-profile-blocks')}>
                        <ColorPalette
                            value={socialIconBackgroundHover}
                            onChange={(value) => setAttributes({ socialIconBackgroundHover: value })}
                        />
                    </BaseControl>
                    ...
                    <SelectControl
                        ...
                        onChange={(value) => setAttributes({ socialIconAlignment: value })}
                    />
                </PanelBody>
            )}
            
            {showMoreContent && (
                <PanelBody title={__('More Content Section', 'author-profile-blocks')} initialOpen={false}>
                    <BaseControl label={__('Border Color', 'author-profile-blocks')}>
                        <ColorPalette
                            value={moreContentBorderColor}
                            onChange={(value) => setAttributes({ moreContentBorderColor: value })}
                        />
                    </BaseControl>
                    ...
                    <RangeControl
                        ...
                        onChange={(value) => setAttributes({ moreContentPadding: value })}
                        min={0}
                        max={50}
                    />
                </PanelBody>
