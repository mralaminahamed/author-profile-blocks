...
Add this CSS to your stylesheet to implement the enhanced features on the documentation site:
...
.apb-feature-icon svg {
  width: 24px;
  height: 24px;
}

.apb-feature-content h4 {
  margin-top: 0;
  margin-bottom: 0.5rem;
}

.apb-feature-content p {
  margin: 0;
}
